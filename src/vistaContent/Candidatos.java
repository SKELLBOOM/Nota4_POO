...
public class Candidatos extends javax.swing.JPanel {
     ...
     */
    public Candidatos(GestionCandidatos gestorCandidatos) {
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        String nombrepartido = txtPartidoPolitico.getText().trim();

        if (nombre.isEmpty() || apellido.isEmpty() || dni.isEmpty() || nombrepartido.isEmpty()) {
